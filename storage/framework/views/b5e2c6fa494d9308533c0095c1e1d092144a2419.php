...
<div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
        ...
        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td style="text-align:left; padding-left:20px;"><input type="checkbox" name="ids" value="<?php echo e($v->role_id); ?>" />
                    </td>
                <td><?php echo e($v->role_name); ?></td>

                <td><div class="button-group"><a class="button border-main" href="<?php echo e(url('/node/allotnode')); ?>?roleid=<?php echo e($v->role_id); ?>"><span class="icon-edit (alias)"></span> 分配权限</a> <a class="button border-red" href="javascript:void(0)" onclick="Competence_del(this,'<?php echo e($v->role_id); ?>')"><span class="icon-trash-o"></span> 删除</a> </div></td>
            </tr>
        ...
        <tr>
            <td colspan="8"><div class="pagelist"> <a href="<?php echo e($data->previousPageUrl()); ?>">上一页</a>
                    ...
                    <a href="http://www.home.com/role/rolelist?page=<?php echo e($i); ?>"><?php echo e($i); ?></a>
                    <?php endfor; ?>
...
<div id="add_administrator_style" class="add_menber" style="display:none">
    <form action="<?php echo e(url('/role/addrole')); ?>" method="post" id="form-admin-add">
...
</html><?php /**PATH D:\PhpStudy20180211\PHPTutorial\WWW\Lxgw\resources\views/admin/role/rolelist.blade.php ENDPATH**/ ?>