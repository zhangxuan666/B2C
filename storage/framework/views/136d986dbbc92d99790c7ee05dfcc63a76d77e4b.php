...
<div class="panel admin-panel margin-top">
  ...
  <div class="body-content">
    <form class="form-x" action="/active/add" method="post">
    	<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
										<div class="form-group">
											...
											<div class="field">
												<input type="text" name="merchant_name" class="input" />
											</div>
										</div>
										<div class="form-group">
											<div class="label">
...
</body></html><?php /**PATH D:\PhpStudy20180211\PHPTutorial\WWW\Lxgw\resources\views/active/oneadd.blade.php ENDPATH**/ ?>