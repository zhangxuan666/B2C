    ...
    <table class="table table-hover text-center">
      ...
      <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
          ...
          <td><?php echo e($data->active_name); ?></td>
          <td><?php echo e($data->merchant_name); ?></td>
          <td><?php echo e($data->begin_time); ?></td>
          <td><?php echo e($data->end_time); ?></td>
          <td><div class="button-group"><a class="button border-yellow" href="/active/oneupdate?id=<?php echo e($data->id); ?>"><span class="icon-edit (alias)"></span>编辑</a><a class="button border-red" href="/active/onedelete?id=<?php echo e($data->id); ?>"><span class="icon-trash-o"></span> 删除</a> </div></td>
        </tr>
...
</html><?php /**PATH D:\PhpStudy20180211\PHPTutorial\WWW\Lxgw\resources\views/active/one.blade.php ENDPATH**/ ?>