            ...
            <div class="admin_modify_style" id="Personal">
                ...
                <div class="xinxi">
                    <div class=" form-group container"><label class="xs1 text-right " for="form-field-1">用户名： </label>
                        <div class="xs11"><input type="text" name="用户名" id="website-title" value="{{$data->user_name}}" class="xs2 text_info" disabled="disabled">
                    ...
                    <div class="form-group container"><label class="xs1 text-right" for="form-field-1">性别： </label>
                        <div class="xs11">
                            <span class="sex">{{$data->user_sex}}</span>
                            <div class="add_sex">
                    ...
                    <div class="form-group container"><label class="xs1 text-right" for="form-field-1">年龄： </label>
                        <div class="xs11"><input type="text" name="年龄" id="website-title" value="{{$data->user_age}}" class="col-xs-7 text_info" disabled="disabled"></div>
                    </div>
                    <div class="form-group container"><label class="xs1 text-right" for="form-field-1">移动电话： </label>
                        <div class="xs11"><input type="text" name="移动电话" id="website-title" value="{{$data->user_phone}}" class="col-xs-7 text_info" disabled="disabled"></div>
                    </div>
                    <div class="form-group container"><label class="xs1 text-right" for="form-field-1">电子邮箱： </label>
                        <div class="xs11"><input type="text" name="电子邮箱" id="website-title" value="{{$data->user_email}}" class="col-xs-7 text_info" disabled="disabled"></div>
                    </div>

                    <div class="form-group container"><label class="xs1 text-right" for="form-field-1">注册时间： </label>
                        <div class="xs11" > <span>{{date("Y-m-d",$data->create_time)}}</span></div>
                    </div>
