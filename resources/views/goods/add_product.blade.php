...
<body>
					...
					<div class="tab">
						...
						<div class="tab-body">
							...
							<div class="tab-panel" id="tab-a">
								<form class="form-x" action="{{url('goods/add_Type_Attribute')}}" method="post">
	  ...
	  @foreach($data as $data)
        <tr>
         ...
         <td>{{$data->type_name}}</td>
          <td>{{$data->type_color}}</td>
          <td>{{$data->type_size}}</td>
  ...
  <div class="tab-panel" id="tab-h">
								<form class="form-x" action="{{url('goods/add_sku')}}" method="post">
								<input type="hidden" name="_token" value="{{ csrf_token() }}">
									<div class="form-group">
										<div class="label">
											<label>商品类型：</label>
										...
										<div class="field field-tsa">
											...
											<div class="field margin-small-top">
											@foreach($checken as $checken)
												<label><input type="checkbox"  name="sku_color[]" value="{{$checken->type_color}}" />{{$checken->type_color}}</label>
												@endforeach
											</div>
										</div>
										<div class="form-group">
											...
											@foreach($check as $check)
												<label><input type="checkbox" name="sku_size[]" value="{{$check->type_size}}"  />{{$check->type_size}}</label>
												@endforeach										
											</div>
