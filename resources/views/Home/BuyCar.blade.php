    ...
    <div class="content mar_20">
    	<table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <?php foreach ($data['info'] as $v) {?>
          <tr>
            <td>
            	<div class="c_s_img"><img src="<?php echo $v['goods_img']?>" width="73" height="73" /></div>
            ...
            <td align="center">
            	<div class="c_num">
                	...
                	<input type="text" value="{{$data['num']}}" name="" class="car_ipt" />
                    <input type="button" value="" onclick="addUpdate1(jq(this));" class="car_btn_2" />
                </div>
            </td>
            <td align="center" style="color:#ff4e00;">￥<?php echo $v['goods_price']?></td>
    ...
    <?php }?>
          ...
          <tr height="70">
          	<td colspan="6" style="font-family:'Microsoft YaHei'; border-bottom:0;">
                ...
                <span class="fr">商品总价：<b style="font-size:22px; color:#ff4e00;">￥{{$data['sum']}}</b></span>
            </td>
          </tr>
